...
/** sha256 of the opaque cookie token; only the hash is ever stored. */
 ...
 * unknown, the session has expired, or the user is disabled.
 */
...
/** Revoke every session for a user, returning the number removed. */
